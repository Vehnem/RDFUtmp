...
//    }
    ...
    protected void onException(Exception e) {
    	if(e instanceof QueryExceptionHTTP) {
    		QueryExceptionHTTP qe = (QueryExceptionHTTP) e;    		
    		QueryExceptionHTTP subCause = (QueryExceptionHTTP) qe.getCause();
    		Logger.getGlobal().warning("Response: "+subCause.getResponse());
    	} 
    }
